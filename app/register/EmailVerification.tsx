...
// export default function EmailVerification({ code }: EmailVerificationProps) {
//   return (
//     <div>
//       <div className="flex flex-col gap-5 justify-center items-center shadow-xl	rounded-lg w-1/2">
//         <h1>Welcome to IEEE student branch registration</h1>
//         <div>Please use the below verification code to register</div>
//         <div>{code}</div>
//       </div>
//     </div>
//   );
