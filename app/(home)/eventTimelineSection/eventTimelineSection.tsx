...
const EventTimelineSection = () => {
  ...
  useEffect(() => {
    ...
    animateElement('.eventtitle', { scale: 0.2, opacity: 0 }, { scale: 1, opacity: 1 });
    gsap.fromTo(
  ...
  return (
    <div className="mx-26 mt-[40px] bg-gradient-to-r from-[#07060D] via-[#0E559D] to-[#0E559D] w-screen max-w-[1400px] rounded-[60px] py-5 relative">
      <h1 className="eventtitle text-[40px] my-5 text-center bg-gradient-to-r from-blue-200 to-cyan-200 bg-clip-text text-transparent " style={{ fontFamily: 'Amenti Bold' }}>EVENTS</h1>
      <div className="flex bg-white rounded-[60px] md:mx-16 mx-7 justify-center mb-10 py-10">
        <div className="content-center column-3">
          <div className="event1 h-[80px] flex rounded-[20px] md:mx-10 mx-5 lg:px-20 md:px-5 px-2 mt-[10px] mb-[120px] bg-gradient-to-r from-[#07060D] via-[#0E559D] to-[#0E559D] justify-center">
            <div className="flex items-center justify-center">
              <div className="text-center">
                <p className="lg:text-lg md:text-[12px] text-[10px] text-white" style={{ fontFamily: 'Amenti Medium' }}>IEEEXtreme 23</p>
                <p className="lg:text-sm md:text-[10px] text-[8px] text-white" style={{ fontFamily: 'Amenti Regular' }}>- November 2023 -</p>
              </div>
            </div>
          </div>
          <div className="event3 h-[80px] flex rounded-[20px] md:mx-10 mx-5 lg:px-20 md:px-5 px-2 mb-[120px] bg-gradient-to-r from-[#07060D] via-[#0E559D] to-[#0E559D] justify-center">
            <div className="flex items-center justify-center">
              <div className="text-center">
                <p className="lg:text-lg md:text-[12px] text-[10px] text-white" style={{ fontFamily: 'Amenti Medium' }}>IEEE Open Week 2024</p>
                <p className="lg:text-sm md:text-[10px] text-[8px] text-white" style={{ fontFamily: 'Amenti Regular' }}>- January 2024 -</p>
              </div>
            </div>
          </div>
          <div className="event5 h-[80px] flex rounded-[20px] md:mx-10 mx-5 lg:px-20 md:px-5 px-2 mb-[120px]  bg-gradient-to-r from-[#07060D] via-[#0E559D] to-[#0E559D] justify-center">
            <div className="flex items-center justify-center">
              <div className="text-center">
                <p className="lg:text-lg md:text-[12px] text-[10px] text-white" style={{ fontFamily: 'Amenti Medium' }}>Mora UXPlore 2.0</p>
                <p className="lg:text-sm md:text-[10px] text-[8px] text-white" style={{ fontFamily: 'Amenti Regular' }}>- April 2024 -</p>
              </div>
            </div>
          </div>
          <div className="event7 h-[80px] flex rounded-[20px] md:mx-10 mx-5 lg:px-20 md:px-5 px-2 mb-[120px]  bg-gradient-to-r from-[#07060D] via-[#0E559D] to-[#0E559D] justify-center">
            <div className="flex items-center justify-center">
              <div className="text-center">
                <p className="lg:text-lg md:text-[12px] text-[10px] text-white" style={{ fontFamily: 'Amenti Medium' }}>Mora Ventures</p>
                <p className="lg:text-sm md:text-[10px] text-[8px] text-white" style={{ fontFamily: 'Amenti Regular' }}>- June 2024 -</p>
              </div>
            </div>
          </div>
          <div className="event9 h-[80px] flex rounded-[20px] md:mx-10 mx-5 lg:px-20 md:px-5 px-2 my-[10px] mb-[80px] bg-gradient-to-r from-[#07060D] via-[#0E559D] to-[#0E559D] justify-center">
            <div className="flex items-center justify-center">
              <div className="text-center">
                <p className="lg:text-lg md:text-[12px] text-[10px] text-white" style={{ fontFamily: 'Amenti Medium' }}>Rise Up Mora 24</p>
                <p className="lg:text-sm md:text-[10px] text-[8px] text-white" style={{ fontFamily: 'Amenti Regular' }}>- August 2024 -</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="content-center column-3">
          ...
          <div className="event4 h-[80px] mt-[120px] flex rounded-[20px] md:mx-10 mx-5 lg:px-20 md:px-5 px-2 bg-gradient-to-r from-[#07060D] via-[#0E559D] to-[#0E559D] justify-center">
            <div className="flex items-center justify-center">
              <div className="text-center">
                <p className="lg:text-lg md:text-[12px] text-[10px] text-white" style={{ fontFamily: 'Amenti Medium' }}>NFB Championship</p>
                <p className="lg:text-sm md:text-[10px] text-[8px] text-white" style={{ fontFamily: 'Amenti Regular' }}>- March 2024 -</p>
              </div>
            </div>
          </div>
          <div className="event6 h-[80px] mt-[120px] flex rounded-[20px] md:mx-10 mx-5 lg:px-20 md:px-5 px-2 bg-gradient-to-r from-[#07060D] via-[#0E559D] to-[#0E559D] justify-center">
            <div className="flex items-center justify-center">
              <div className="text-center">
                <p className="lg:text-lg md:text-[12px] text-[10px] text-white" style={{ fontFamily: 'Amenti Medium' }}>MoraForesight 2.0</p>
                <p className="lg:text-sm md:text-[10px] text-[8px] text-white" style={{ fontFamily: 'Amenti Regular' }}>- January 2024 -</p>
              </div>
            </div>
          </div>
          <div className="event8 h-[80px] mt-[120px] flex rounded-[20px] md:mx-10 mx-5 lg:px-20 md:px-5 px-2 bg-gradient-to-r from-[#07060D] via-[#0E559D] to-[#0E559D] justify-center">
            <div className="flex items-center justify-center">
              <div className="text-center">
                <p className="lg:text-lg md:text-[12px] text-[10px] text-white" style={{ fontFamily: 'Amenti Medium' }}>MERCon 2024</p>
                <p className="lg:text-sm md:text-[10px] text-[8px] text-white" style={{ fontFamily: 'Amenti Regular' }}>- August 2024 -</p>
              </div>
            </div>
          </div>
