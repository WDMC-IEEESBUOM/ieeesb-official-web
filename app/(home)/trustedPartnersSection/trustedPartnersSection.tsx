...
const StrategicPartnerSection = () => {
  ...
  return (
    <div className="mx-26 mt-[40px] bg-gradient-to-r from-[#07060D] via-[#0E559D] to-[#0E559D] w-screen max-w-[1400px] rounded-[60px] py-5 relative mb-[40px]">
      <h1
        className="chaptertitle my-1 md:text-[40px] text-[30px] text-center mb-4 bg-gradient-to-r from-blue-200 to-cyan-200 bg-clip-text text-transparent"
        ...
        <div className="grid grid-cols-1 grid-rows md:grid-cols-2 md:grid-rows-1 md:gap-4">
          ...
          <div className="flex items-center justify-center">
            <div
              ...
              className="flex flex-col items-start w-full space-y-4 md:border-l md:border-gray-300 pl-4 text-justify bg-gradient-to-r from-[#07060D] via-[#0E559D] to-[#0E559D] bg-clip-text text-transparent"
            >
              <p>{partnerDescription}</p>
              <h2 className="text-lg font-semibold mb-2">
                {partnerName}
                <Link href={websiteLink}>www.ifs.com</Link>
              </h2>
            </div>
          </div>
        </div>
